...
// import { OBJExporter } from './exporters/obj-exporter';
// import { STLExporter } from './exporters/stl-exporter';
// import { GLTFExporter } from './exporters/gltf-exporter';
...
export default function ToolbarSaveButton({ state }) {
  ...
  //     const scene3D = new Three.Scene();
  //     scene3D.add(planData.plan);
  //     browserDownload(stlExporter.parse(scene3D, { binary: true }), "stl");
  //   })
  // }
  ...
  //     const scene3D = new Three.Scene();
  //     scene3D.add(planData.plan);
  //     browserDownload(gltfExporter.parse(scene3D), "gltf");
  //   })
  // }
  ...
  const menu = (
    <Menu style={{ width: 140 }}>
      ...
      {/* <MenuItem key="2" onClick={saveProjectToObjFile}>OBJ</MenuItem>
        <MenuItem key="3" onClick={saveProjectToStlFile}>STL</MenuItem>
        <MenuItem key="4" onClick={saveProjectToGltfFile}>GLTF</MenuItem> */}
    </Menu>
  );
